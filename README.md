...
| 图 4 · RFM 客户分层 | 哪一类客户最该优先维护或挽回？ | 200 位客户中「一般客户」83 人却贡献 37.2% 的 GMV；「重要挽留客户」48 人贡献 27.5% |
...
<tr>
<td><img src="docs/figures/fig3_product_pareto.png" alt="商品 GMV 集中度"></td>
<td><img src="docs/figures/fig4_rfm_matrix.png" alt="RFM 客户分层"></td>
</tr>
</table>
...
测试覆盖：数据清洗边界、日期解析（含 Excel 序列号开区间）、输入错误处理、图表空输入与配色循环、仪表盘端到端渲染、以及**数据可复现性**。
